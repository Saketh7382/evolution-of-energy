...
export default function GetBookPage() {
  const retailer = process.env.AMAZON_BOOK_URL || "https://www.amazon.in/dp/B0HDM1NWVJ";
  return <section style={{padding:"100px 0 128px",minHeight:"70vh"}}><Container reading>
    ...
    <p style={{marginTop:28}}><a href={retailer} target="_blank" rel="noopener noreferrer" style={{display:"inline-block",background:"var(--eoe-gold)",color:"var(--eoe-midnight)",padding:"14px 24px",textDecoration:"none",borderRadius:3,fontWeight:600}}>Get it on Amazon</a></p>
  </Container></section>;
}
